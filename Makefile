...
SRCS2 = command1_bonus.c command2_bonus.c command3_bonus.c ft_atoi_bonus.c ft_split_bonus.c get_next_line_bonus.c get_next_line_utils_bonus.c make_and_error_bonus.c man_bonus.c push_swap_bonus.c push_and_pop_bonus.c 
OBJS = $(SRCS:.c=.o)
OBJS2 = $(SRCS2:.c=.o)
